...
class Settings(BaseSettings):
    ...
    # V9.6 Validation Acceleration: broader PAPER learning capture only.
    # These settings DO NOT relax READY/PAPER_SIGNAL trading rules.
    learning_capture_enabled: bool = True
    learning_capture_min_score: int = 45
    learning_capture_min_state: str = "WATCH"
    ...
    # V9.9: conservative forward-diagnostic filter.
    v99_filter_enabled: bool = True
    v99_min_bucket_samples: int = 8
    v99_block_expectancy_r: float = -0.20
    ...
    learning_min_samples_warning: int = 10
    learning_min_samples_usable: int = 30
    learning_min_samples_strong: int = 100
